...
public class StudentRegistrationServiceImpl implements StudentRegistrationService {
	...
	public List<StudentRegistration> findRegistrationByCourseId(int theId) {
		...
		if (result != null )
			...
			throw new RuntimeException("Did not find student registration with id - " + theId);
	}
	...
	public void setStudentRegistrationGrades(StudentRegistration theStudentRegistration, double projectGrade, double finalExamsGrade) {
		theStudentRegistration.setProject_grade(projectGrade);
		theStudentRegistration.setFinal_exams_grade(finalExamsGrade);
	}
